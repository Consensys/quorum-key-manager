...
func (c *HTTPClient) CreateKey(ctx context.Context, storeName string, req *types2.CreateKeyRequest) (*types2.KeyResponse, error) {
	key := &types2.KeyResponse{}
...
func (c *HTTPClient) ImportKey(ctx context.Context, storeName string, req *types2.ImportKeyRequest) (*types2.KeyResponse, error) {
	key := &types2.KeyResponse{}
...
func (c *HTTPClient) Sign(ctx context.Context, storeName, id string, req *types2.SignBase64PayloadRequest) (string, error) {
...
func (c *HTTPClient) GetKey(ctx context.Context, storeName, id string) (*types2.KeyResponse, error) {
	key := &types2.KeyResponse{}
