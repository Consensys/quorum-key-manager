...
type Eth1Client interface {
	...
	SignEth1(ctx context.Context, storeName string, request *types.SignHexPayloadRequest) (string, error)
	SignTypedData(ctx context.Context, storeName string, request *types.SignTypedDataRequest) (string, error)
	SignTransaction(ctx context.Context, storeName string, request *types.SignETHTransactionRequest) (string, error)
	SignQuorumPrivateTransaction(ctx context.Context, storeName string, request *types.SignQuorumPrivateTransactionRequest) (string, error)
	SignEEATransaction(ctx context.Context, storeName string, request *types.SignEEATransactionRequest) (string, error)
