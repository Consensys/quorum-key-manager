...
func New(smng stores.Manager, manifests manifestsmanager.Manager, authManager auth.Manager, aliasManager aliases.AliasBackend, aliasParser placeholder.AliasParser, logger log.Logger) *BaseManager {
	return &BaseManager{
		stores:      smng,
		manifests:   manifests,
