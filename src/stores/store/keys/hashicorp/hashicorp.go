...
// Create a key
func (s *Store) Create(_ context.Context, id string, alg *entities2.Algorithm, attr *entities2.Attributes) (*entities2.Key, error) {
...
// Import a key
func (s *Store) Import(_ context.Context, id string, privKey []byte, alg *entities2.Algorithm, attr *entities2.Attributes) (*entities2.Key, error) {
	logger := s.logger.WithField("id", id)
...
// Get a key
func (s *Store) Get(_ context.Context, id string) (*entities2.Key, error) {
	logger := s.logger.WithField("id", id)
...
// Gets a deleted key
func (s *Store) GetDeleted(_ context.Context, id string) (*entities2.Key, error) {
	return nil, errors.ErrNotImplemented
}
