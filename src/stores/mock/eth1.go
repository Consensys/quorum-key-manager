...
func (m *MockEthStore) List(ctx context.Context) ([]common.Address, error) {
	m.ctrl.T.Helper()
...
func (mr *MockEthStoreMockRecorder) List(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "List", reflect.TypeOf((*MockEthStore)(nil).List), ctx)
}
...
func (m *MockEthStore) ListDeleted(ctx context.Context) ([]common.Address, error) {
	m.ctrl.T.Helper()
...
func (mr *MockEthStoreMockRecorder) ListDeleted(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListDeleted", reflect.TypeOf((*MockEthStore)(nil).ListDeleted), ctx)
}
