...
# Verify certs
openssl verify -CAfile $GEN_DIR/ca.crt $GEN_DIR/qkm-client-no-auth.pem $GEN_DIR/qkm-client-auth.pem $GEN_DIR/vault-server.pem $GEN_DIR/vault-client.pem $GEN_DIR/postgres-server.pem $GEN_DIR/postgres-client.pem
...
mv $GEN_DIR/postgres-server.pem $DEST_DIR_CERTS/https.crt
mv $GEN_DIR/postgres-server-key.pem $DEST_DIR_CERTS/https.key
